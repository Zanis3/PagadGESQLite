package com.example.pagadgesqlite;
    ...
    public void addStudentRecord() {
        addRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Double.parseDouble(studentSemGrade.getText().toString()) < 50 || Double.parseDouble(studentSemGrade.getText().toString()) > 100) {
                    displayMessage("Error!", "Grades are only allowed between 50 and 100");
                    return;
                }
    ...
    public void editStudentRecord() {
        editRecord.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cursor = db.rawQuery("SELECT * FROM tbl_student WHERE student_id = " + Integer.parseInt(studentId.getText().toString()), null);
                if (cursor.moveToFirst()) {
                    db.execSQL("UPDATE tbl_student SET student_name='" + studentName.getText().toString() +
                            "', student_semGrade='" + studentSemGrade.getText().toString() +
